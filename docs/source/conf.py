# -*- coding: utf-8 -*-
#
# Capture SDK documentation build configuration file, created by
# sphinx-quickstart on Mon May  2 17:57:57 2016.
#
...
release = re.sub('^v', '', os.popen('git describe --long').read().strip())
